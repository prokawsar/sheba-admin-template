<div class="container mt-20">
	<div class="flex flex-wrap">
		...
		>
			<div
				class="outline outline-1 shadow-md outline-teal-500 relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border"
			>
				<div class="p-6 mb-0 text-center bg-white border-b-0 rounded-t-2xl">
					<h5>Register with</h5>
				</div>
				<div class="flex flex-wrap px-3 sm:px-6 xl:px-12">
				...
				<div class="flex-auto p-6">
					<form>
						<div class="mb-4">
							<input
								type="text"
								class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border-2 border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-teal-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
								placeholder="Name"
								aria-label="Name"
						...
						<div class="min-h-6 pl-6 mb-1 block">
							<input
								id="terms"
								class="w-4 h-4 ease-soft -ml-6 rounded-sm checked:bg-gradient-to-tl checked:from-gray-900 checked:to-slate-800 after:text-xxs after:font-awesome after:duration-250 after:ease-soft-in-out duration-250 relative float-left mt-1 cursor-pointer appearance-none border border-solid border-slate-200 bg-white bg-contain bg-center bg-no-repeat align-top transition-all after:absolute after:rounded-md after:flex after:h-full after:w-full after:items-center after:justify-center after:text-white after:opacity-0 after:transition-all after:content-['\2713'] checked:border-0 checked:border-transparent checked:bg-transparent checked:after:opacity-100"
								type="checkbox"
								value=""
							/>
							<label
							...
							>
								I agree the
								<a href="" class="font-bold text-slate-700"> Terms and Conditions </a>
							</label>
						</div>
						...
						<p class="mt-4 mb-0 leading-normal text-sm">
							...
							<a href="/signin" class="font-bold text-slate-700"> Sign in </a>
						</p>
					</form>
				</div>
			</div>
